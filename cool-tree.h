...
#include <vector>
#include "tree.h"
#include "cool-tree.handcode.h" // 这一行至关重要，它引入了我们定义的扩展方法
...
// 注意：这里删除了 GetArgNum 和 GetName，因为我们在 handcode.h 的 method_EXTRAS 中定义了
...
// 注意：删除了 GetActuals，已由 handcode.h 接管
#ifdef Expression_SHARED_EXTRAS
    Expression_SHARED_EXTRAS
#endif
...
// 注意：删除了 GetCases，已由 handcode.h 接管
#ifdef Expression_SHARED_EXTRAS
    Expression_SHARED_EXTRAS
#endif
